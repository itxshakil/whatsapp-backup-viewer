...
export const AboutPage: React.FC<AboutPageProps> = React.memo(({ onClose }) => {
  return (
    <div className="fixed inset-0 z-[100] bg-white dark:bg-[#111b21] flex flex-col animate-fade-in h-screen h-[100dvh] overflow-hidden">
      <div className="h-[60px] flex items-center justify-between px-4 bg-[#f0f2f5] dark:bg-[#202c33] border-b border-gray-300 dark:border-gray-700/50 flex-shrink-0">
        <div className="flex items-center gap-4">
          <button 
            onClick={onClose} 
            className="p-2 hover:bg-black/5 dark:hover:bg-white/5 rounded-full transition-colors text-[#54656f] dark:text-[#aebac1]"
            aria-label="Close"
          >
            <X size={24} />
          </button>
          <h2 className="text-lg font-semibold text-[#111b21] dark:text-[#e9edef]">About & How to Use</h2>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-4xl mx-auto p-6 md:p-12 space-y-16">
          ...
          <section className="text-center space-y-4">
            <div className="w-20 h-20 bg-[#00a884] rounded-2xl mx-auto flex items-center justify-center shadow-lg transform rotate-3">
              <Info size={40} className="text-white" />
            </div>
            <h1 className="text-3xl font-bold text-[#111b21] dark:text-[#e9edef]">WhatsApp Backup Viewer</h1>
            <p className="text-[#667781] dark:text-[#8696a0] max-w-md mx-auto text-lg leading-relaxed">
          ...
          <section className="space-y-10">
            <div className="text-center space-y-2">
              <h2 className="text-2xl font-bold text-[#111b21] dark:text-[#e9edef] flex items-center justify-center gap-3">
                <BookOpen className="text-[#008069] dark:text-[#00a884]" size={28} />
                Getting Started
              </h2>
              <p className="text-[#667781] dark:text-[#8696a0]">Follow these 4 simple steps to view your chat</p>
            </div>
